...
static unsigned int sampling_down_factor = MIKASA_SAMPLING_DOWN_FACTOR;
static unsigned int min_online_cpus = MIKASA_MIN_ONLINE_CPUS;
static unsigned int boost_duration = MIKASA_BOOST_DURATION;
static unsigned int touch_boost_duration = MIKASA_TOUCH_BOOST_DURATION;
